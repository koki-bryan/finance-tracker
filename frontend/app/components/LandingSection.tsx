...
const LandingSection = () => {
  return (
    <section className="bg-linear-to-tr from-blue-50/80 to-indigo-100/50 pb-8 shadow mb-0.5">
      <div className="max-w-6xl mx-auto p-6 pt-16 grid-cols-1 grid items-center gap-6 lg:gap-8 xl:gap-10 lg:grid-cols-2">
        <div className="flex flex-col gap-4 ">
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            <button className="p-4 text-base bg-indigo-600 font-poppins text-white rounded-xl cursor-pointer">
